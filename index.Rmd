...
--
- Thromboprophylaxis prophylaxis used `tromb`
...
--
- such that $Y = f(\beta X)$ for function $f(\beta X) = \beta X$ in linear regression,
...
Note that  $$\beta X = (\beta_0, \dots, \beta_p)\cdot(1, X_1, \dots, X_p)^T = \sum_{i = 0}^p \beta_i X_i = \beta_0 + \beta_1 X_1 + \dots + \beta_p X_p$$
...
- I said that $Y = \beta X$

--
- I lied! 

--
- Actually $Y = \beta X + \varepsilon$ 
...
--
4. Does it look like $e \approx \varepsilon\sim N(0,\sigma)$?
...
--
- Plot $e = Y - \hat \beta X$ (in different ways)
...
- Model interaction without main effects
- Interpret coefficients of interaction effects directly
